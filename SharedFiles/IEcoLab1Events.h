...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
	int16_t (ECOCALLMETHOD *ShowRoots)(struct IEcoLab1Events* me, const void* coefs_data, size_t coefs_count, const char* name_type);
	int16_t (ECOCALLMETHOD *ShowPoly)(struct IEcoLab1Events* me, const void* coefs_data, size_t coefs_count, const char* name_type);
    int16_t (ECOCALLMETHOD *ShowState)(struct IEcoLab1Events* me, const void* buffer_char, const void* coefs_data, size_t coefs_count, const char* name_type, size_t buff_ind, size_t coef_ind);
